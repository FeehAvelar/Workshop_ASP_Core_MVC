...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 3500.00, new DateTime(1979, 12, 31), d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", 2200.00, new DateTime(1988, 1, 15), d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", 3000.00, new DateTime(1993, 11, 30), d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", 4000.00, new DateTime(2000, 1, 9), d3);
            Seller s6 = new Seller(6, "Alex Pink", "bob@gmail.com", 3000.00, new DateTime(1997, 3, 4), d2);
